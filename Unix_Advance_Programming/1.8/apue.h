/* Our own header, to be ncluded before all standard sstem hearders */

#ifndef _APUE_H
#define _APUE_H

#define _X_OPEN_SOURCE 600 /* Single UNIX Specification, Version 3 */
...
int send_fd(int, int);			/* Figure 17.19 */
int send_err(int, int,
	 const char *);			/* Figure 17.10 and 17.15 */
